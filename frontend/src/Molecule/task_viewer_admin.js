...
function TaskViewer() {
  ...
  const restrictedpage = () => {
    navigate("/restricted_page", { replace: true })
  }
      ...
      >
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          ...
          <Container maxWidth="lg">
            <h1 style={{ textAlign: "left", marginTop: "50px" }}>Welcome</h1>
            <p style={{ textAlign: "left" }}>
              {" "}                 
              <b>Username: {usernames.username}</b> &nbsp;|&nbsp; <i>Role: {usernames.userType} </i>  &nbsp;|&nbsp; Name: {usernames.name}

              <p>
              <Button variant="contained" color="error" onClick={restrictedpage}>  
                Access to restricted page
              </Button>
